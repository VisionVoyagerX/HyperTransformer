...
def main():
    ...
    model = HyperTransformer(64, mslr_mean=train_dataset.mslr_mean.to(device), mslr_std=train_dataset.mslr_std.to(device), pan_mean=train_dataset.pan_mean.to(device),
    ...
    save_interval = 500
    report_interval = 50
    test_intervals = [1000, 2000, 3000,
                      4000, 5000, 6000, 7000, 8000, 9000, 10000]
    evaluation_interval = [1000, 2000, 3000,
                           4000, 5000, 6000, 7000, 8000, 9000, 10000]
    ...
    for step in train_progress_bar:
        if step % save_interval == 0 and step != 0:
            ...
            save_checkpoint(checkpoint, 'hypertransformer_GF2', current_daytime)
        ...
        if (step + 1) in evaluation_interval and step != 0:
            ...
            if val_metrics[-1]['psnr'] > best_eval_psnr:
                ...
                checkpoint = {'step': step,
                              ...
                              'val_metrics': val_metrics,
                              'test_metrics': test_metrics}
                save_checkpoint(checkpoint, 'hypertransformer_GF2',
        ...
        if (step + 1) in test_intervals and step != 0:
            ...
            if test_metrics[-1]['psnr'] > best_test_psnr:
                ...
                checkpoint = {'step': step,
                              ...
                              # 'val_metrics': val_metrics,
                              'test_metrics': test_metrics}
                save_checkpoint(checkpoint, 'hypertransformer',
