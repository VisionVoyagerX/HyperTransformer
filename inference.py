...
def main():
    ...
    model = HyperTransformer(16, mslr_mean=train_dataset.mslr_mean.to(device), mslr_std=train_dataset.mslr_std.to(device), pan_mean=train_dataset.pan_mean.to(device),
    ...
    if continue_from_checkpoint:
        tr_metrics, val_metrics, test_metrics = load_checkpoint(torch.load(
            'checkpoints/hypertransformer/hypertransformer_2023_07_21-14_13_19.pth.tar'), model, optimizer, tr_metrics, val_metrics, test_metrics)
        print('Model Loaded ...')'''
